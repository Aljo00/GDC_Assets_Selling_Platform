        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-in-up">
            ...
            <p className="text-lg md:text-xl mb-8 text-gray-300 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              I'm revealing the exact strategies that helped my clients and me
              grow from 0 to 50K+ subscribers—no ads, no tricks, just proven
              systems.
            </p>
          ...
          >
            <div className="relative w-full max-w-sm">
              ...
              <div
                className="absolute -bottom-8 -right-8 w-48 h-48 bg-purple-500 rounded-full mix-blend-lighten filter blur-3xl opacity-30 animate-blob"
              ...
              <div className="relative bg-white/10 backdrop-blur-lg rounded-3xl p-6 border border-white/20 shadow-2xl">
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  <div>
                    <p className="text-3xl lg:text-4xl font-bold text-[#FFC700]">
                      1.2M+
                    </p>
